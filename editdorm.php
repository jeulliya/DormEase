...
if (isset($_POST['submit'])) {
    ...
    $stmt = $conn->prepare("UPDATE dormitories SET images=?, lat=?, lng=?, dorm_name=?, dorm_owner=?, address=?, rooms=?, r_fee=?, amenities=?, r_avail=?, description=?, b_permit=? WHERE dorm_id=?");
    $stmt->bind_param("sddsssiissssi", $images, $lat, $lng, $dorm_name, $dorm_owner, $address, $rooms, $r_fee, $amenities, $r_avail, $description, $b_permit, $id);
    $stmt->execute();
    $stmt->close();
...
<body>
    ...
    <form method="post" action="editdorm.php?edit=<?php echo $id; ?>" enctype="multipart/form-data">
            ...
            <div class="input-container">
                ...
                <div class="location-container">
                    <div class="input-pair">
                        ...
                        <input class="input1" type="text" id="lat" name="lat" value="<?php echo $lat?>" autocomplete="off" readonly>
                    </div>
                    <div class="input-pair1">
                        <label for="lng">Longitude:</label>
                        <input class="input1" type="text" id="lng" name="lng" value="<?php echo $lng?>" autocomplete="off" readonly>
                    </div>
                </div>  
                ...
                <label for="b_permit" class="permit">Do you have Business Permit?</label>
                    <div class="radio-container">
                        <input type="radio" id="yes" name="b_permit" value="Yes" <?php echo ($b_permit === 'Yes') ? 'checked' : ''; ?> required>
                        <label for="yes">Yes</label>

                        <input type="radio" id="no" name="b_permit" value="No" <?php echo ($b_permit === 'No') ? 'checked' : ''; ?> required>
                        <label for="no">No</label>
                    </div>
            </div>
            <div class="submit-container2">
                <input class="submit" type="submit" name="submit" value="Submit">
                <a href="dorm-list.php" class="cancel" type="cancel" name="cancel">Cancel</a><br>
            </div>
        </form>
    </div>
